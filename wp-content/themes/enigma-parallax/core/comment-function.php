...
function enigma_parallax_comment( $comment, $args, $depth ) 
{
    ...
    <div class="media enigma_comment_box">
           ...
           <div class="media-body">
				...
				<?php comment_date(); ?>
				<?php endif; ?>
				<?php _e('at','enigma-parallax');?>&nbsp;<?php comment_time('g:i a'); ?></span>
				<?php comment_text() ; ?>				
				<div class="reply">
				...
				<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'enigma-parallax' ); ?></em>
				<br/>
				<?php endif; ?>
				</div>
			</div>							
