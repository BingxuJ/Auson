<div id="post-<?php the_ID(); ?>" <?php post_class('enigma_blog_full'); ?>>
	...
	<div class="post-content-wrap">
		...
		<div class="enigma_blog_thumb_wrapper_showcase">						
			...
			<?php the_post_thumbnail('enigma_parallax_blog_2c_thumb',$img); ?>						
			</div>
			<?php if (is_home()) : ?>
		...
		<h2><?php if(!is_single()) {?><a href="<?php esc_url(the_permalink()); ?>"><?php } ?><?php the_title(); ?></a></h2>
		<div class="row">
		...
		$defaults = array(
              'before'           => '<div class="enigma_blog_pagination"><div class="enigma_blog_pagi">' . __( 'Pages:','enigma-parallax'  ),
              'after'            => '</div></div>',
	          'link_before'      => '',
	          'link_after'       => '',
	          'next_or_number'   => 'number',
	          'separator'        => ' ',
	          'nextpagelink'     => __( 'Next page'  ,'enigma-parallax' ),
	          'previouspagelink' => __( 'Previous page' ,'enigma-parallax'),
	          'pagelink'         => '%',
	          'echo'             => 1
	          );
