<!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <?php $wl_theme_options = weblizar_get_options();
		...
		$ImageUrl2 = WL_TEMPLATE_DIR_URI ."/images/1.png";
		$ImageUrl3 = WL_TEMPLATE_DIR_URI ."/images/1.png";  ?>
		...
		<div class="item">		
          ...
          <div class="container">
            ...
            <a class="enigma_blog_read_btn animated bounceInUp" href="<?php if($wl_theme_options['slide_btn_link_3']!='') { echo esc_url($wl_theme_options['slide_btn_link_3']); } ?>" role="button"><?php echo "New string" ?></a>
			  <?php } ?>
            </div>
			<?php } ?>
			</div>
