	...
	<div class="carousel-inner">
	  <?php $wl_theme_options = enigma_parallax_get_options();  ?>
		<div class="item active">
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/winem1.png" class="img-responsive" alt="<?php echo esc_attr($wl_theme_options['slide_title_1']); ?>">
			<?php }  ?>		  
			<div class="container">
		...
		<div class="item">		
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/winem3.png" class="img-responsive" alt="<?php echo esc_attr($wl_theme_options['slide_title_2']); ?>">
			<?php } ?>
			<div class="container">
				<div class="carousel-caption">			
		...
		<div class="item">		
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/winem4.png" class="img-responsive" alt="<?php echo esc_attr($wl_theme_options['slide_title_3']); ?>">
			<?php } ?>
			 <div class="container">
				<div class="carousel-caption">
		...
		<div class="item">		
			...
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/winem7.png" class="img-responsive" alt="<?php echo esc_attr($wl_theme_options['slide_title_4']); ?>">
			<?php } ?>
			 <div class="container">
				<div class="carousel-caption">
